 ...
 *  apps/backend/functions/api/me/index.ts returns and the renderer's
...
async function routeRequest(
  ...
  // apps/backend/functions/api/me/index.ts): display_name +
  ...
  // (see apps/backend/functions/api/handles/check.ts:11)
