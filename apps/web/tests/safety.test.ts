...
const SCAN_ROOTS = [
  // The whole merged web app — reader render path, helpers, and the
  // marketing surface (the old landing layout used
  // dangerouslySetInnerHTML for inline CSS; the merged app must not,
  // so the guard covers everything).
